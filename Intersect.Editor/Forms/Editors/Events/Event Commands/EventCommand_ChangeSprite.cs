        ...
        private void UpdatePreview()
        {
            ...
            if (File.Exists("resources/entities/" + cmbSprite.Text))
            {
                ...
                g.DrawImage(
                    sourceBitmap,
                    new Rectangle(
                        pnlPreview.Width / 2 - sourceBitmap.Width / (Options.Instance.Sprites.NormalFrames * 2), pnlPreview.Height / 2 - sourceBitmap.Height / (Options.Instance.Sprites.DirectionFrameRows * 2),
                        sourceBitmap.Width / Options.Instance.Sprites.NormalFrames, sourceBitmap.Height / Options.Instance.Sprites.DirectionFrameRows
                    ), new Rectangle(0, 0, sourceBitmap.Width / Options.Instance.Sprites.NormalFrames, sourceBitmap.Height / Options.Instance.Sprites.DirectionFrameRows), GraphicsUnit.Pixel
                );
            }
